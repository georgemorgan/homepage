...
**[Download](./papers/2014.pdf)**

This paper outlines the steps that I took to create an embedded development platform, called Flipper, from scratch. In this paper I describe the methodologies that I used to design the hardware, firmware, and general architecture of the platform. This project is open source and is available on GitHub [here](https://github.com/flipper-io/flipper).

### Operating System Design and Development Continued

**[Download](./papers/2013.pdf)**
